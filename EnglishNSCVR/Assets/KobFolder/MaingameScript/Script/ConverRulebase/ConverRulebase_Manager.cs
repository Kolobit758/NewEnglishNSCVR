...
public class ConverRulebase_Manager : MonoBehaviour

{
    ...
    // private NPCResponse Response_Ask_Feels(SO_WordIntent wordIntent)
    // {
    //     int ranFormatNum = Random.Range(0, wordIntent.dialogueFormat.Count);
    //     int ranResNum = Random.Range(0, wordIntent.resWords.Count);
    //     string resText = wordIntent.dialogueFormat[ranFormatNum].Replace("{feels}", wordIntent.resWords[ranResNum]);

    //     NPCResponse response = new NPCResponse(resText, "normal", false, null);
    //     return response;
    // }

    // private NPCResponse Response_Ask_Weather(SO_WordIntent wordIntent)
    // {
    //     int ranFormatNum = Random.Range(0, wordIntent.dialogueFormat.Count);
    //     int ranResNum = Random.Range(0, wordIntent.resWords.Count);
    //     string resText = wordIntent.dialogueFormat[ranFormatNum].Replace("{Weather}", wordIntent.resWords[ranResNum]);

    //     NPCResponse response = new NPCResponse(resText, "normal", false, null);
    //     return response;
    // }

    // private NPCResponse Response_Greating(SO_WordIntent wordIntent)
    // {
    //     int ranFormatNum = Random.Range(0, wordIntent.dialogueFormat.Count);
    //     int ranResNum = Random.Range(0, wordIntent.resWords.Count);
